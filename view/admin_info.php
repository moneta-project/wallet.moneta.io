...
<p></p>
    <div class="col-md-2"><button type="submit" class="btn btn-default"><span>CHANGE PASSWORD</span></button></div>
</form>
<p id="pwdmsg"></p>
<br />
<p>Send funds:</p>
<form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" class="clearfix" id="withdrawform">
    ...
    <div class="col-md-2"><button type="submit" class="btn btn-default">Send</button></div>
</form>
<p id="withdrawmsg"></p>
<br />
<p>Addresses:</p>
